          ...
          <div className="space-y-16 md:space-y-20">
            {posts.map((post, i) => (
              <article key={post.id} id={post.id} className="space-y-6 scroll-mt-24">
                <header className="notes-post-header !mb-0 sticky top-16 md:top-0 z-10 pt-6 pb-6 md:pt-8 md:pb-8 bg-[linear-gradient(to_bottom,var(--color-background)_0%,var(--color-background)_72%,transparent_100%)]">
                  <h3>{post.title}</h3>
